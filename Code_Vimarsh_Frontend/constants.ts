...
export const MOCK_MANAGED_ACHIEVEMENTS: ManagedAchievement[] = [
  { id: 'ma1', title: 'IBM Hackathon 2024 - 2nd Position', description: 'Secured the 1st Runner Up position at the prestigious IBM Hackathon for building an innovative AI-driven enterprise solution.', date: 'MAY 2024', tag: 'Hackathon', icon: '🥈', category: 'Hackathon', order: 1, createdAt: '2024-05-10T00:00:00Z', updatedAt: '2024-05-10T00:00:00Z' },
  { id: 'ma2', title: 'IBM Hackathon 2024 - 3rd Position', description: 'Secured the 2nd Runner Up position at the IBM Hackathon, showcasing exceptional problem-solving and cloud architecture skills.', date: 'MAY 2024', tag: 'Hackathon', icon: '🥉', category: 'Hackathon', order: 2, createdAt: '2024-05-10T00:00:00Z', updatedAt: '2024-05-10T00:00:00Z' },
  { id: 'ma3', title: 'MSU Hackathon - 3rd Position', description: 'Bagged the 3rd position in our home university hackathon with a stellar web application prototype.', date: 'FEB 2024', tag: 'Hackathon', icon: '🥉', category: 'Hackathon', order: 3, createdAt: '2024-02-15T00:00:00Z', updatedAt: '2024-02-15T00:00:00Z' },
  { id: 'ma4', title: 'Smart India Hackathon Winners', description: 'Secured 1st prize in the software edition, competing against 500+ teams nationwide.', date: 'DEC 2023', tag: 'Hackathon', icon: '🥇', category: 'Hackathon', order: 4, createdAt: '2023-12-01T00:00:00Z', updatedAt: '2023-12-01T00:00:00Z' },
  { id: 'ma5', title: '100+ PRs in Hacktoberfest', description: 'Club milestone reached in a single month — 100+ merged pull requests to major open-source repos.', date: 'OCT 2023', tag: 'Open Source', icon: '⭐', category: 'Open Source', order: 5, createdAt: '2023-10-31T00:00:00Z', updatedAt: '2023-10-31T00:00:00Z' },
];
...
export const MOCK_TEAM: TeamMember[] = [
 ...
 { id: 't4', name: 'Kavya Patel', section: 'Team Leads', role: 'Web Team Head', image: '/Kavya Patel Web Team Head.jpg', linkedin: 'https://www.linkedin.com/in/kavya-patel-msu/', github: 'https://github.com/K9Patel', email: 'kavya.patel@codevimarsh.org' },
  ...
  { id: 'w9', name: 'Bhavika Giyanani', section: 'Web Team', role: 'Backend Team Lead', image: '/Bhavika Giyanani Web Team Member.jpg', linkedin: '', github: '', email: 'bhavika.giyanani@codevimarsh.org' },
  // Management
  ...
  { id: 'm2', name: 'Madhvi Mungra', section: 'Management', role: 'Management Team Member', image: '/Madhvi Mungra Management Team Member.jpg', linkedin: 'https://www.linkedin.com/in/mungara-madhvi-466526338', github: 'https://github.com/Madhavi-1202', email: 'madhvi.mungra@codevimarsh.org' },
  ...
  { id: 'd5', name: 'Shiv Patel', section: 'Design Team', role: 'Design Team Member', image: '/Shiv Patel Design Team Member.jpeg', linkedin: 'https://www.linkedin.com/in/shiv-patel-86665930a', github: 'https://github.com/Shiv230604', email: 'shiv.patel@codevimarsh.org' },
];
...
export const MOCK_ALUMNI: Alum[] = [
  {
    id: '1', name: 'Sandeep Parmar', initials: 'SP',
    role: 'Software Engineer', company: 'Google', batch: '2023', location: 'India', domain: 'Software Dev' as any,
    bio: 'Software Engineer at Google. Passionate about scalable systems and competitive programming.',
    advice: 'Focus heavily on Data Structures and Algorithms. Participate in regular contests to build problem-solving speed.',
    tech: ['C++', 'Python', 'Go', 'Distributed Systems'],
    linkedin: 'https://linkedin.com/in/sandeep-parmar', github: 'https://github.com/sandeepparmar',
    achievements: ['Google SWE', 'Code Vimarsh Event Lead', 'Multiple Hackathon Winner'],
    roadmap: [
  ...
  {
    id: '2', name: 'Jay Prajapati', initials: 'JP',
    role: 'Software Engineer', company: 'Mastercard', batch: '2023', location: 'India', domain: 'Backend / DevOps' as any,
    bio: 'Building robust financial systems at Mastercard. Tech enthusiast and open-source contributor.',
    advice: 'Understand the business impact of your code. Good engineering is about solving real-world problems.',
    tech: ['Java', 'Spring Boot', 'Microservices', 'SQL'],
    linkedin: 'https://linkedin.com/in/jay-prajapati', github: 'https://github.com/jayprajapati',
    achievements: ['SDE at Mastercard', 'Strong Backend Developer', 'Active Mentor'],
    roadmap: [
  ...
  {
    id: '3', name: 'Jay Fanse', initials: 'JF',
    role: 'Software Engineer', company: 'Glomopay', batch: '2023', location: 'India', domain: 'Frontend / Web' as any,
    bio: 'Developing payment infrastructure at Glomopay. Love exploring modern web technologies.',
    advice: 'Stay consistent. It is better to code 1 hour every day than 7 hours on Sunday.',
    tech: ['JavaScript', 'React', 'Node.js', 'Fintech APIs'],
    linkedin: 'https://linkedin.com/in/jay-fanse', github: 'https://github.com/jayfanse',
    achievements: ['Core Developer at Glomopay', 'Full Stack Expert', 'Hackathon Mentor'],
    roadmap: [
  ...
  {
    id: '4', name: 'Krupal Patel', initials: 'KP',
    role: 'Software Engineer', company: 'SocialPilot', batch: '2024', location: 'India', domain: 'Software Dev' as any,
    bio: 'Software Engineer at SocialPilot, crafting seamless user experiences and scalable backend services.',
    advice: 'Never hesitate to ask for help, but always try to read the documentation first.',
    tech: ['React', 'Node.js', 'MongoDB', 'AWS'],
    linkedin: 'https://linkedin.com/in/krupal-patel', github: 'https://github.com/krupalpatel',
    achievements: ['SDE at SocialPilot', 'Code Vimarsh Event Coordinator', 'Full Stack Developer'],
    roadmap: [
  ...
  {
    id: '5', name: 'Kuldeep Sinh Jhala', initials: 'KJ',
    role: 'Software Engineer', company: 'Futentia Solutions', batch: '2024', location: 'India', domain: 'Software Dev' as any,
    bio: 'Driving technological innovation at Futentia Solutions. Passionate about problem-solving and software architecture.',
    advice: 'Build projects that you actually want to use. That passion will show in your code and interviews.',
    tech: ['Python', 'Django', 'React', 'Cloud Infra'],
    linkedin: 'https://linkedin.com/in/kuldeep-sinh-jhala', github: 'https://github.com/kuldeepsinhjhala',
    achievements: ['SDE at Futentia Solutions', 'Tech Innovator', 'Community Mentor'],
    roadmap: [
